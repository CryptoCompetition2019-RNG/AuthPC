...
public class TableSuccess extends JFrame implements MouseListener {

	JLabel bacgrangd, jan, bi, PP, pp, tu;// gif,最小化，关闭，logo，QQ，头像
	JLabel an1, an2;// 暗色块|线
	JPanel bgcolor;// 白
	JLabel text1, text2, text3;// 更改密码，注消账号，登录成功
	...
	public TableSuccess() {
		...
		an2 = new JLabel();
		bgcolor = new JPanel();
		text1 = new JLabel("更改密码");
		text2 = new JLabel("注消账号");
		text3 = new JLabel("登录成功");
		submit = new JLabel();
